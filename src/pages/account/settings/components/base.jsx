...
class BaseView extends Component {
  ...
  handleFinish = (values) => {
    ...
    dispatch({
      type: 'accountAndsettings/updatePassword',
      payload: {...values,username},
    })
      .then(function (res) {
        console.log('res', res);
        res ? message.success('更新成功') : message.error('更新失败');
      })
      .catch((error) => {
      ...
      <div className={styles.baseView} ref={this.getViewDom}>
        <div className={styles.left}>
          ...
          >
            ...
            <Form.Item name="newPassword" label="新密码" hasFeedback>
              <Input
                type="password"
...
export default connect(({ accountAndsettings, loading }) => ({
  ...
  submitting: loading.effects['accountAndsettings/updatePassword'],
}))(BaseView);
