...
const TableList = (props) => {
  ...
  const {
    dispatch,
    authAndauthResourceCate: { resourceCateList, pagination },
  } = props;
  const dataColumns = [
    {
      title: '资源分类名称',
   ...
   *
   */
  const queryResourceCate = async (values) => {
    console.log('values', values);
    dispatch({
      type: 'authAndauthResourceCate/queryResourceCate',
      payload: values,
    });
  };
  ...
  return (
    <PageContainer>
      <ProTable
        ...
        request={async (params) => queryResourceCate({ ...params })}
        dataSource={resourceCateList}
        columns={dataColumns}
        rowSelection={{
...
export default connect(({ authAndauthResourceCate }) => ({
  authAndauthResourceCate,
}))(TableList);
