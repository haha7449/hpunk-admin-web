...
import { queryOrder,getOrderItemList,deleteOrder } from '../../../services/order';
import { getComment } from '../../../services/product';
const Model = {
  namespace: 'orderAndorderList',
  ...
  reducers: {
    ...
    showOrder(state, { payload }) {
      ...
      console.log('showOrder-payload', payload);
